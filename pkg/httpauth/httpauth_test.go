...
func Test_LookupSchemeFromAddress(t *testing.T) {
	...
	input := map[string]string{
		"vulnmap.khulnasoft.com:443":     "https",
		"vulnmap.khulnasoft.com:80":      "http",
		"vulnmap.khulnasoft.com:1080":    "socks5",
		"vulnmap.khulnasoft.com":         defaultValue,
		"vulnmap.khulnasoft.com:443:das": defaultValue,
	}
