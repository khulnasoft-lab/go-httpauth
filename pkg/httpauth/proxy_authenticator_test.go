...
import (
	...
	"github.com/khulnasoft-lab/go-httpauth/test/helper"
	"github.com/stretchr/testify/assert"
	"golang.org/x/net/http/httpproxy"
)

//go:generate $GOPATH/bin/mockgen -source=authenticationhandler.go -destination ./httpauth_generated_mock.go -package httpauth -self_package github.com/khulnasoft-lab/go-httpauth/pkg/httpauth
...
func Test_ProxyAuthenticator_connectToProxy_fail02(t *testing.T) {
	...
	context := context.Background()
	mechanism := Negotiate
	proxyUrl := &url.URL{Opaque: "https://vulnmap.khulnasoft.com"}
...
func Test_ProxyAuthenticator_connectToProxy_fail03(t *testing.T) {
	...
	target := "vulnmap.khulnasoft.com:443"
	createConnectionFunc := func() (net.Conn, error) { return nil, nil }
...
func Test_ProxyAuthenticator_DialContext_fail02(t *testing.T) {
	...
	target := "vulnmap.khulnasoft.com:7831" // used random not existing port which will not find an appropriate proxy
	proxyFunc := func(*http.Request) (*url.URL, error) { return proxyUrl, nil }
...
func Test_ProxyAuthenticator_DialContext_success03_1(t *testing.T) {
	...
	os.Setenv("NO_PROXY", "localhost,vulnmap.khulnasoft.com")
